...
(* OASIS_START *)
(* DO NOT EDIT (digest: 721d2cf46656daa97834ff8e0919764e) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "xenstore_server_domain";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\015\136\232\185z\183`~\214\012+\236\213;\180>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
