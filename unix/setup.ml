...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8973584e06bf51b23132e58c5ebc58a4) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
                             [
                                "-I.";
                                "-I/local/scratch/djs/.opam/system/lib";
                                "-I/local/scratch/djs/.opam/system/lib/lwt";
                                "-I/usr/lib/ocaml/lwt"
                             ])
                        ];
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "xenstore_server_unix";
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xenstore.server", None);
                           InternalLibrary "xenstore_server_unix"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\011\162i\0158\228_X\162!\202\181\017\220x^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
